      ...
      <div className="hidden lg:flex relative flex-col justify-between p-16 text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-6xl font-black tracking-tight leading-[1.1] mb-6">
            From Soil <br />
            <span className="text-blue-400 font-outline">to Store.</span>
          </h2>
        ...
        <div className="max-w-md w-full relative z-10">
          <div className="bg-white lg:bg-transparent rounded-[2.5rem] p-10 lg:p-0 shadow-2xl shadow-slate-200 lg:shadow-none border border-slate-100 lg:border-none">
            <div className="mb-10 lg:text-left text-center">
              <div className="lg:hidden inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-2xl mb-4 border border-blue-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-blue-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-blue-200 hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50"
                >
            ...
            <div className="mt-10 lg:text-left text-center">
              <p className="text-slate-600 font-bold uppercase tracking-widest text-[11px]">
                New to AgriTrace?{' '}
                <Link to="/register" className="text-blue-700 hover:text-blue-800 transition-colors ml-1 font-black underline underline-offset-4 decoration-2">
                  Sign Up
                </Link>
              </p>
            </div>
